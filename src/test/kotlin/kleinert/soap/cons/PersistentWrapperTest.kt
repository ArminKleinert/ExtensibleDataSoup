...
class PersistentWrapperTest {
    @Test
    fun testConstructor() {
        assertTrue(PersistentWrapper.of<Int>() == PersistentWrapper(listOf<Int>()))
        assertTrue(PersistentWrapper<Int>(listOf()) == PersistentWrapper(listOf<Int>()))
        assertTrue(PersistentWrapper(listOf<Int>().asIterable()) == PersistentWrapper(listOf<Int>()))
        assertTrue(PersistentWrapper(PersistentWrapper.of<Int>()) == PersistentWrapper(listOf<Int>()))

        assertTrue(PersistentWrapper(listOf(1)) == PersistentWrapper(listOf(1)))
        assertTrue(PersistentWrapper(listOf(1).asIterable()) == PersistentWrapper(listOf(1)))

        assertTrue(PersistentWrapper(listOf(1, 2, 3, 4, 5)) == PersistentWrapper(listOf(1, 2, 3, 4, 5)))
    ...
    fun cons() {
        ...
        assertEquals(PersistentWrapper(listOf(1)), list.cons(1))
        assertEquals(PersistentWrapper(listOf(2, 1)), list.cons(1).cons(2))
        assertEquals(PersistentWrapper(listOf(3, 2, 1)), list.cons(1).cons(2).cons(3))
    }

    @Test
    fun cdr() {
        assertInstanceOf(PersistentWrapper::class.java, PersistentWrapper.of<Int>().cdr)
        assertInstanceOf(PersistentWrapper::class.java, PersistentWrapper.of(2, 1).cdr)
        assertEquals(PersistentWrapper.of<Int>(), PersistentWrapper.of<Int>().cdr)
    ...
    @Test
    fun contains() {
        assertFalse(PersistentWrapper.of<Int>().contains(1))
        assertFalse(PersistentWrapper.of<String>().contains(""))
    ...
    @Test
    fun containsAll() {
        assertTrue(PersistentWrapper.of<Int>().containsAll(listOf()))

        assertFalse(PersistentWrapper.of<Int>().containsAll(listOf(1)))
        assertFalse(PersistentWrapper.of<String>().containsAll(listOf("")))
    ...
    @Test
    fun isEmpty() {
        assertTrue(PersistentWrapper.of<Int>().isEmpty())
        assertTrue(PersistentWrapper.of<String>().isEmpty())
        assertTrue(PersistentWrapper<Int>(listOf()).isEmpty())
        assertTrue(PersistentWrapper(listOf(1)).cdr.isEmpty())

        assertFalse(PersistentWrapper.of<Int>().cons(1).isEmpty())
        assertFalse(PersistentWrapper.of<Int>().cons(1).cons(2).isEmpty())
        assertFalse(PersistentWrapper.of<Int>().cons(1).cons(2).cons(3).isEmpty())
        assertFalse(PersistentWrapper(listOf(2, 1, 3)).isEmpty())

        assertFalse(PersistentWrapper.of<Int>().isNotEmpty())
        assertFalse(PersistentWrapper.of<String>().isNotEmpty())
        assertFalse(PersistentWrapper<Int>(listOf()).isNotEmpty())
        assertFalse(PersistentWrapper(listOf(1)).cdr.isNotEmpty())

        assertTrue(PersistentWrapper.of<Int>().cons(1).isNotEmpty())
        assertTrue(PersistentWrapper.of<Int>().cons(1).cons(2).isNotEmpty())
        assertTrue(PersistentWrapper.of<Int>().cons(1).cons(2).cons(3).isNotEmpty())
    ...
    @Test
    fun toMutableList() {
        assertTrue(PersistentWrapper.of<Int>().toMutableList().isEmpty())
