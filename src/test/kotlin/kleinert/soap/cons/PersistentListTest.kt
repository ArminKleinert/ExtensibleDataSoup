...
class PersistentListTest {
    ...
    fun from() {
        assertInstanceOf(PersistentList::class.java, PersistentList.from<Boolean>(listOf()))
        assertEquals(PersistentWrapper.of<Boolean>(), PersistentList.from<Boolean>(listOf()))

        assertInstanceOf(PersistentWrapper::class.java, PersistentList.from(listOf(true)))
        assertEquals(PersistentWrapper.of(true), PersistentList.from(listOf(true)))

        assertInstanceOf(PersistentWrapper::class.java, PersistentList.from(listOf(true, false)))
        assertEquals(PersistentWrapper.of(true, false), PersistentList.from(listOf(true, false)))
    }
